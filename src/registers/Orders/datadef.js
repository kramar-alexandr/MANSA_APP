module.exports = {
    ...
    indexes: {
        delivery_index: { fields: ['delivery', 'address'], indicesType: 'UNIQUE' }, // unique multiple index
        search_index:   { fields: ['comment', 'order_name'] }, // common multiple index]
        comments_index: { fields: [ 'comment' ] }, // common index
        fulltext_index: { fields: [ 'supplier' ], indicesType: 'FULLTEXT' } // common fulltext index для больших строк
    }
};
